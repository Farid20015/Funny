...
from Funny.config import Config
from telethon.sync import TelegramClient, events
import asyncio
import logging
import regex
from telethon import utils
from Funny.FastTelethon import download_file, upload_file
...
def archive_files(msg_ids):
    ...
    for msg_id in msg_ids:
      message = bot.get_messages("DigiAnime", ids=msg_id)
